...
class CollectionTest extends TestCase
{
    ...
    {   
        $collection = collect(["Bram"]);
        $result = $collection->mapInto(Person::class);
        $this->assertEquals([new Person("Bram")], $result->all());
    }
    ...
    public function testMapSpread()
    {
        ...
        assertEquals([
            new Person("Bramasta Albatio"),
            new Person("Nova Precilia"),
        ], $result->all());
    }
    ...
    {
        $collection1 = collect(["ibu",2,3]);
        $collection2 = collect(["bapak",5,6]);
    ...
    public function testCombine()
    {
        ...
        $collection2 = collect(["Bramasta", "Indonesia"]);
    ...
    public function testStringRepresetation()
    {
        $collection = collect(["Bramasta", "Albatio", "Haryono"]);

        $this->assertEquals("Bramasta-Albatio-Haryono", $collection->join("-"));
        $this->assertEquals("Bramasta-Albatio_Haryono", $collection->join("-","_"));
    }
    ...
    {
        $collection = collect(["Bramasta", "Albatio", "Haryono"]);
        $this->assertTrue($collection->contains("Bramasta"));
        $this->assertTrue($collection->contains(function ($value, $key){
            return $value == "Haryono";
        }));   
    }
    ...
    public function testSlicing()
    {
        ...
        $result = $collection->slice(5, 2);
        $this->assertEqualsCanonicalizing([6,7], $result->all());
    }
    ...
    public function testCheckingExistence()
    {
        ...
        $this->assertFalse($collection->contains(900));
        $this->assertTrue($collection->contains(function ($value, $key){
            return $value == 8;
        }));
    ...
    {
        $collection = collect([1,2,3,4,5,6,9,8,7]);
